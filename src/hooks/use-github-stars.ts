...
import { logDebug, logWarn } from "@/modules/analytics/lib/otel";

const CACHE_KEY = "syntaxdiff:github-stars";
const CACHE_TTL_MS = 24 * 60 * 60 * 1000;
const REPO_URL = "https://api.github.com/repos/dimasbaguspm/syntaxdiff";
...
function fetchStars(): Promise<number | null> {
  if (!inFlight) {
    inFlight = fetch(REPO_URL, { headers: { Accept: "application/vnd.github+json" } })
